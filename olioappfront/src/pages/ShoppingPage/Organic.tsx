...
function Organic() {
    ...
    const filteredProducts = productData.filter((item) => (item.name ? item.name:'') && item.organic === true).reverse() ;
    ...
    {/* Hero  */}
                    <div className="flex relative justify-center align-middle">
                        ...
                        <div id="hero-text" className="text-center absolute w-1/2">
                            <h1 className="mt-12 text-4xl font-bold text-white sm:text-6xl">Organic</h1>
