...
function Flavored() {
    ...
    const filteredProducts = productData.filter((item, index) => item.name! && item.flavored === true).reverse() ;
    ...
    {/* Hero  */}
                    <div className="flex relative justify-center align-middle">
                        ...
                        <div id="hero-text" className="text-center absolute w-1/2">
                            <h1 className="mt-16 text-4xl font-bold text-white sm:text-6xl">Flavored Olive Oil</h1>
